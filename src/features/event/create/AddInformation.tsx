...
export const AddInformation = () => {
  const { video } = useContext(CreateEventContext)
  ...
  return (
    <div className="p-1 w-full sm:gap-8 pt-6 h-full flex flex-col-reverse sm:flex-row will-change-[none]">
      <div className='w-full sm:w-[55%]'>
        ...
        <Input className='bg-[#141414] border-[#333] mt-4' placeholder='Title'/>
        <Textarea className='bg-[#141414] border-[#333] resize-none h-36 mt-2' placeholder='Description'/>
      ...
      <div className='w-full sm:w-[45%]'>
        <div style={{aspectRatio: 16 / 9}} className='rounded-t-2xl'>
          {video && <video src={URL.createObjectURL(video)} width={1920} height={1080} className='w-full h-full bg-gradient-to-b from-[#151515] to-black rounded-t-2xl' controls/>}
        </div>
