...
export const NoEvents = () => {
  return (
      <>
          ...
          <div className='h-screen w-screen absolute top-0 left-0 z-40 bg-black opacity-25'/>
          <div
              className='h-screen w-screen absolute top-0 left-0 bg-gradient-to-t from-40% sm:from-45% from-black to-trasparent z-40'/>
      </>
  )
}